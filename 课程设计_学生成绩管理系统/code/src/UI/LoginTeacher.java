...
public class LoginTeacher extends JFrame{
	...
	//输入项
	private JLabel jlb1 = new JLabel("教师号: "), jlb2 = new JLabel("密码:  ");
	private JLabel	title = new JLabel("教师登录界面");
	//文本框
	private JTextField jtfid = new JTextField();
	private JPasswordField jtfpassword = new JPasswordField();
	private int num=0;
	public LoginTeacher(int i) {
		this.num=i;
		this.init();
		this.addListener();
	}
		...
		ok.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(status==1) {
					...
					TeacherOn.start(num);
					LoginTeacher.this.setVisible(false);
				}else {
	...
	public static void start(int i) {
		new LoginTeacher(i).setVisible(true);
	}
}
