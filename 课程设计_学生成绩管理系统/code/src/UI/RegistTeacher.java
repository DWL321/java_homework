...
public class RegistTeacher extends JFrame{
	//整体布局
		...
		ok.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(status==1) {//在通过了前端校验的情况下。
					String passmsg ="4:"+jtfid.getText() + ";" + jtfname.getText() + ";" + t;
				...
				if(status==1) {
					RegistOK.start(num);
					RegistTeacher.this.setVisible(false);
				}else {
	...
	public static void start(int i) {
		new RegistTeacher(i).setVisible(true);
	}
}
